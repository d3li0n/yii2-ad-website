...
class SiteController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout', 'create-post'],// TODO create-post hide
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
     ...
     * @return string
     */
    public function actionSearchByText()
    {
        ...
        $ads = $adComponents->searchAdByText($param);
